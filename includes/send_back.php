...
if ($row) {
    ...
    echo '<form id="editForm" method="post" action="includes/send_back_inv.php">
        ...
        <div class="form-group">
            <label for="itemCategory">Item Sub Category</label>
            <input type="text" class="form-control" id="itemMode" name="itemMode" value="' . ($row['item_mode_issue'] ?? '') . '" readonly >
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="site" name="site" value="' . ($row['item_site'] ?? '') . '" >
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="issuedTo" name="issuedTo" value="' . ($row['item_issued_to'] ?? '') . '" readonly>
        </div>
        ...
        <button type="submit" class="btn btn-primary" name="submit">Send Back to Inventory</button>
    </form>';
