...
<div id="wrapper">
  ...
  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item active">
      ...
      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="dropdown-item" href="history.php">Activity Log</a>
    ...
    <li class="nav-item active">
      <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false"
      ...
      <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          <h6 class="collapse-header">Components</h6>
          <a class="dropdown-item" href="issued_item.php">Issued Items List</a>
    ...
    <?php if ($_SESSION['type'] === 'admin'): ?>
      <li class="nav-item active">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false"
          aria-controls="collapseOne">
          <i class="fas fa-fw fa-user"></i>
          <span>Log In Activity</span>
        </a>
        <div id="collapseOne" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Components</h6>
            <a class="dropdown-item" href="login_activity.php">Log in Activity Log</a>
            <a class="dropdown-item" href="user_status.php">User Status</a>
          </div>
        </div>
      </li>
    <?php endif; ?>
    ...
    <!-- Activity Log -->
    <li class="nav-item active <?php echo ($_SESSION['type'] === 'admin') ? 'active' : ''; ?>">
      <?php if ($_SESSION['type'] === 'admin'): ?>
    ...
    <li class="nav-item <?php echo ($_SESSION['type'] === 'admin') ? 'active' : ''; ?>">
      <?php if ($_SESSION['type'] === 'admin'): ?>
