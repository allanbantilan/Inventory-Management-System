...
if ($row) {
    ...
    echo '<form id="editForm" method="post" action="includes/issue_item.php">
        <div class="form-group">
            <label for="itemName">Serial Number</label>
            <input type="text" class="form-control" id="assetTag" name="assetTag" value="' . ($row['asset_tag'] ?? '') . '" readonly >
        </div>
        <div class="form-group">
            <label for="itemName">Serial Number</label>
            <input type="text" class="form-control" id="serialNumber" name="serialNumber" value="' . ($row['serialNumber'] ?? '') . '" readonly >
        </div>

        <div class="form-group">
            <label for="itemCategory">Item Category</label>
            <select class="form-control" id="itemCategory" name="itemCategory" readonly >
    ...
    echo '</select>
        ...
        <select class="form-control" id="itemSubCategory" name="itemSubCategory" readonly>
            <option value="" disabled>Select an option</option>';
    ...
    echo '</select>
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="itemStatus" name="itemStatus" readonly>
                <option value="" disabled>Select an option</option>';
    ...
    echo '</select>
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="site" name="site" readonly>
                <option value="" disabled>Select an option</option>';
    ...
    echo '</select>
        ...
        <input type="date" class="form-control" id="dateCreated" name="dateCreated" value="' . ($row['dateAdded'] ?? '') . '" readonly >
    </div>
        <div class="form-group">
            <label for="description">Description</label>
            <!-- Change input field to textarea -->
            <textarea class="form-control" id="description" name="description" rows="5" readonly>' . ($row['description'] ?? '') . ' </textarea>
        </div>
        <div class="form-group">
    ...
    document.getElementById("editForm").addEventListener("submit", function(event) {
        ...
        var dateCreated = document.getElementById("dateCreated").value; // Corrected field name
