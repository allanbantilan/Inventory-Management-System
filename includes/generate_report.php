            ...
            <div class="card shadow square-card mb-4">
                ...
                <div class="card-body">
                    <form id="reportForm" action="includes/generate_report_PI.php" method="post">
                        ...
                        <div class="form-group row">
                            <label for="itemSubCategory" class="col-sm-3 col-form-label">Sub Category</label>
                            <div class="col-sm-9">
...
<script>
$(document).ready(function () {
    $('#categoryInv').change(function () {
        var selectedCategory = $(this).val();
        $.ajax({
            url: '/inventory/includes/fetch_sub_categories_report.php', // Adjust the URL to your PHP script
            type: 'POST',
