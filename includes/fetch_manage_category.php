...
if(isset($_GET['id'])) {
    ...
    if($result) {
        ...
        if(mysqli_num_rows($result) > 0) {
            ...
            echo '<form id="editCategoryForm" action="includes/update_category.php" method="post">';
            echo '<input  type="hidden" name="categoryID" value="' . $categoryData['categoryID'] . '">'; // Include the category ID in a hidden input field
            echo 'Category Name: <input type="text" class="form-control" name="categoryName" value="' . $categoryData['category'] . '"><br>';
